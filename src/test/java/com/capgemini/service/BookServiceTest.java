...
public class BookServiceTest {
    ...
    public void testShouldFindBookById() {
        ...
        final long bookId = 1;
        // when
        Book bookEntity = mSUT.findBookById(bookId);
        // then
    ...
    public void testShouldFindBooksByTitle() {
        ...
        // when
        List<Book> booksEntity = mSUT.findBooksByTitle(bookTitle);
        // then
    ...
    public void testShouldFindBooksByAuthor() {
    	...
    	// when
    	List<Book> booksEntity = mSUT.findBooksByAuthor(authorId);
    	// then
    	assertNotNull(booksEntity);
    ...
    public void testShouldSaveBook() {
    	...
    	final Book book = new Book(null, "Pan Tadeusz");
    	// when
    	Book savedBook = mSUT.saveBook(book);
    	// then
